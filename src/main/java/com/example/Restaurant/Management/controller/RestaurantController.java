...
import com.example.Restaurant.Management.model.Restaurant;
...
public class RestaurantController {
    ...
    @GetMapping("/{id}")
    public <Restaurant> ResponseEntity<Restaurant> getRestaurantById(@PathVariable Long id) {
        Restaurant restaurant = (Restaurant) getRestaurantFromListById(id);
